...
export default class UserController{
    ...
    async login(req,res){
        try{
            ...
            const validPassword = await bcrypt.compare(password,existingUser.password);//verificar que la contraseña sea valida
            if(!validPassword){
    ...
    async updateUser(req,res){
        try{
            const {id}=req.user;//este dato lo tomara directamente del token
